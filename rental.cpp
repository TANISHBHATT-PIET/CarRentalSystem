...
class rent : public customer 
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' MARUTI VITARA BREZZA."<<endl;
        cout<<"\t\t\t\tEnter 'B' MAHINDRA XUV700."<<endl;
        cout<<"\t\t\t\tEnter 'C' HYUNDAI CRETA."<<endl;
        cout<<"\t\t\t\tEnter 'D' TATA NEXON."<<endl;
        cout<<endl;
 ...
 {
 	system("CLS");
		cout<<"You have choosed MARUTI VITARA BREZZA"<<endl;
		 ifstream inA("A.txt"); 
         char str[200];
         while(inA) {
         inA.getline(str, 200);  
...
sleep(2);
  ...
  {
  	system("CLS");
		cout<<"You have choosed MAHINDRA XUV700"<<endl;
		 ifstream inB("B.txt"); 
         char str[200];
         while(inB) {
         inB.getline(str, 200);  
 ...
 {
 	system("CLS");
	     cout<<"You have choosed HYUNDAI CRETA"<<endl;
		 ifstream inC("C.txt"); 
         char str[200];
         while(inC) {
         inC.getline(str, 200);  
...
void showrent()
    ...
    cout << "\t\t	| Customer Name:"<<"-----------------|"<<setw(10)<<customername<<" |"<<endl;
     cout << "\t\t	| Mobile Number:"<<"-----------------|"<<setw(10)<<phonenumber<<" |"<<endl;
